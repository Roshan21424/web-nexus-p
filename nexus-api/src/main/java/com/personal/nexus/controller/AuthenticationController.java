...
import com.personal.nexus.DTO.LoginRequest;
import com.personal.nexus.DTO.LoginResponse;
import com.personal.nexus.DTO.SignupRequest;
import com.personal.nexus.DTO.UserInfoResponse;
import com.personal.nexus.entity.Student;
import com.personal.nexus.entity.Teacher;
import com.personal.nexus.entity.User;
import com.personal.nexus.security.jwtutils.JwtUtils;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> signup(@Valid @RequestBody SignupRequest signupRequest) {
        ...
        try {
            ...
            Optional<User> existingUser = userService.findByName(signupRequest.getName());
            ...
            if (role == User.Role.STUDENT) {
                ...
                student.setStudentRole(Student.StudentRole.NORMAL); // required field
                user = student;
    ...
    public ResponseEntity<?> getUserDetails(@AuthenticationPrincipal UserDetails userDetails) {
        ...
        if (userDetails == null) {
            System.out.println("username is: "+userDetails);
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
